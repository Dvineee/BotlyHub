  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className={`w-10 h-10 flex items-center justify-center rounded-2xl border transition-all active:scale-90 shadow-lg ${
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-3 w-56 bg-white dark:bg-slate-900/95 border border-slate-200 dark:border-slate-800 rounded-[28px] shadow-2xl overflow-hidden z-[100] py-2 backdrop-blur-2xl"
          >
