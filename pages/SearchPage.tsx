...
const NavMenu = ({
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                    {appsCategories.map((cat) => (
                      <button
                        ...
                        className="flex items-center gap-2.5 p-2 rounded-xl transition-all duration-200 text-left bg-slate-50/50 dark:bg-slate-800/10 border border-slate-100/50 dark:border-slate-800/20 hover:bg-blue-500/[0.04] dark:hover:bg-blue-500/[0.04] hover:border-blue-550/15 group w-full cursor-pointer"
                      >
                        <div className="w-7 h-7 rounded-lg bg-white dark:bg-slate-900 border border-slate-200/55 dark:border-slate-800 flex items-center justify-center text-slate-450 dark:text-slate-450 group-hover:bg-blue-500 group-hover:text-white dark:group-hover:bg-blue-650 dark:group-hover:text-white/95 transition-all duration-200 shrink-0 shadow-xs">
                          <cat.icon size={14} />
                        </div>
  ...
  return (
    <>
      <header
        ref={internalMenuRef}
        className="hidden md:block relative md:sticky md:top-0 z-40 bg-white dark:bg-slate-950 border-b border-[#f7f7f7] dark:border-white/5 w-full py-2.5 transition-colors"
      >
    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300 search-page">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 pt-0 md:pt-0 pb-32">
          {/* Results */}
          <div className="relative z-[200] bg-white dark:bg-slate-950 py-3 -mx-5 px-5 sm:-mx-8 sm:px-8 md:mx-0 md:px-0 flex items-center gap-3 mb-0 md:mb-2 transition-colors">
