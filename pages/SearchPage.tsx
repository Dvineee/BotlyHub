...
const NavMenu = ({
  ...
  return (
    <>
      <header
        ref={internalMenuRef}
        className="hidden md:block relative md:sticky md:top-0 z-[300] bg-white dark:bg-slate-950 border-b border-[#f7f7f7] dark:border-white/5 w-full py-2.5 transition-colors"
      >
