...
import { Search as SearchIcon, ChevronLeft, ChevronDown, X, Zap, Loader2, Sparkles, Send, Bot as BotIcon, Star, Sun, Moon, Wallet, Menu, Store, User, Bell, Megaphone, LayoutGrid, Share2, ExternalLink, BarChart3, Coins, Briefcase, Compass, ArrowLeft, Plus, LogOut, MessageSquare, Globe } from 'lucide-react';
      ...
      <div className="mb-10">
        ...
        >
          {(searchMode === 'bots' ? categories : [{id: 'all', label: 'cat_all', icon: Sparkles}, ...appsSubCategories]).map((cat) => (
            ...
            >
              <cat.icon size={16} className={activeCategory === cat.id ? 'text-[#0a263d] dark:text-white font-bold' : 'text-[#0a263d]/60 dark:text-slate-400'} />
